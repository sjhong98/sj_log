  ...
  return (
    <>
      ...
      >
        ...
        <Typography variant="body1" className="text-[#333] group-hover:text-[#ddd] duration-100">
          Search ⌘K
        </Typography>
      </Row>

      <Dialog open={open} onClose={() => setOpen(false)} className="overflow-hidden">
        <DialogContent className="bg-[#111] text-[#ddd] !p-0 overflow-hidden">{dialogComponent}</DialogContent>
      </Dialog>
    </>
  )
}
